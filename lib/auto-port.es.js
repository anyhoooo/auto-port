  ...
  if (target.$ref) {
    ...
    if (target.oneOf) {
      ...
      if (data.type === "array") {
        ...
        if (data.allOf) {
          var _type3 = getModeleType(data.allOf[0].$ref);
          ...
          if (innerData.type === "array") {
            if (innerData.items.$ref) {
              ...
              return "".concat(_type3, "<").concat(innerType, "[]>");
            } else {
              return "".concat(_type3, "<").concat(transCSharpTypeToTyscriptType(innerData.items.type, innerData.items.format), "[]>");
            }
          } else {
            if (innerData.$ref) {
              ...
              return "".concat(_type3, "<").concat(_innerType, ">");
            } else {
          ...
          var _type4 = getModeleType(data.$ref);
      ...
      if (target.type === "array") {
        if (target.items.$ref) {
          var _type5 = getModeleType(target.items.$ref);
