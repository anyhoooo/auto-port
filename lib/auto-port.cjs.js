...
function apiFile(module, apis, enumMap, modelMap, dirname, basePath) {
  ...
  apis.forEach(function (api) {
    if (checkIsNeedUpdate('api', module + '/' + api.name, api)) {
      ...
      writeFile(api.name, generateFun.apiTemplate(api, usedModel, usedEnum, module, basePath), dirname); // console.log(chalk.greenBright(dirname + '/' + api.name + ' 接口已更新'))
